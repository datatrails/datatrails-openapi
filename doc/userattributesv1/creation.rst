...
.. _userattributesv1v2_creation:

User Attributes Creation
------------------------
...
.. note::
    attributes
        Attribute name and value to set
    ...
    See `Swagger POST API <openapi.html#post--archivist-v2-userattributesv1>`_
