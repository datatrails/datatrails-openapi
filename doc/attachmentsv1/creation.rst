...
.. code-block:: JSON
    ...
    {
      "operation": "Attach",
      "behaviour": "AttachmentsV1",
      "attributes": {
          "attachment_identity": "attachments/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
      },
...
.. note::
    ...
    See `Swagger POST API <openapi.html#post--archivist-v2-attachmentsv1>`_
